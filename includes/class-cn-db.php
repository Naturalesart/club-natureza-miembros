...
class CN_DB {
	...
	/**
	 * Corre en cada carga del admin y reinstala el esquema si cambió la versión.
	 * Necesario porque dbDelta solo corre automáticamente en la activación del plugin,
	 * y este plugin ya está activo en producción cuando se agregan tablas/columnas nuevas.
	 */
